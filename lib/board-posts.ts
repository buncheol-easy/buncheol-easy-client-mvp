...
export const boardPosts: BoardPost[] = [
  {
    ...
    isNew: true,
    isPinned: true,
    summary: "낙찰 후 입금 안내와 확인 흐름이 계좌이체 기준으로 정리돼요.",
    body: [
      "PG 결제 연동 전까지 낙찰 상품 결제는 계좌이체 기반으로 운영될 예정이에요.",
  ...
  },
  {
    ...
    body: [
      "낙찰 후 결제 대기 상태로 바뀐 분철은 안내된 시간 안에 입금해 주세요.",
      "기한이 지나면 주최자 확인이나 운영 정책에 따라 낙찰 상태가 변경될 수 있어요.",
      "입금 전에는 상품명, 멤버 옵션, 배송지를 다시 한 번 확인하는 걸 추천해요.",
    ],
    action: {
      href: "/profile/bids",
      label: "입찰 기록으로 이동",
      title: "결제할 낙찰 내역을 확인해요",
    },
  },
  {
  ...
  },
  {
    ...
    body: [
      "분철 마감 후 백엔드에서 낙찰 순위와 결제 대기 상태를 계산해 반영해요.",
      "상태 반영 전에는 입찰 기록에서 아직 입찰 중이거나 미낙찰처럼 보일 수 있어요.",
      "잠시 후 다시 확인하면 결제 가능한 낙찰 항목이 갱신돼요.",
    ],
    action: {
      href: "/profile/bids",
      label: "입찰 기록으로 이동",
      title: "내 입찰 상태를 다시 확인해요",
    },
  },
  {
  ...
  },
  {
    ...
    body: [
      "분철 등록 후 참여자가 입찰을 시작하면 옵션 변경이 어려울 수 있어요.",
      "멤버별 옵션, 최소 입찰가, 배송 가능 택배사를 등록 전에 다시 확인해 주세요.",
