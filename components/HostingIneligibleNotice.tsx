...
const hostingRequirementItems = [
  ...
  {
    title: "한 번에 너무 많이 열 수는 없어요",
    description:
      "모집·입금 수집이 진행 중인 분철이 쌓이면 새로 개최할 수 없어요. 진행 중인 분철을 확정해 정리하면 다시 열 수 있어요. 참여는 개수 제한 없이 자유롭게 하실 수 있어요.",
  },
];
...
function getNoticeCopy(
  ...
  if (reason === "LIMIT_EXCEEDED") {
    return {
      ...
      description:
        "모집·입금 수집이 진행 중인 분철이 많아 새로 열 수 없어요. 이 분철들을 확정해 정리하면 다시 개최할 수 있어요.",
      sectionTitle: "이렇게 하면 돼요",
      items: [
        {
          title: "지금 할 수 있는 것",
