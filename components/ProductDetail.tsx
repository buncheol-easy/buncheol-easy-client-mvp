...
export function ProductDetail({
  ...
  /*
   * 찜은 개최자에게도 열어 둔다.
   * 전에는 수정 권한(= 내 분철)이 있으면 하트를 통째로 숨겼는데, 목록 카드에서는
   * 내 분철에도 하트가 보인다 — 카드에서 찜해 놓고 상세로 들어오면 해제할 방법이 없었다.
   * 서버도 자기 분철 북마크를 허용한다(POST 201 / DELETE 204).
   * 임시 저장 분철만 제외한다 — 서버에 레코드가 없어 북마크 호출이 404 난다.
   */
